...
describe("PicksetGenerator", function () {
  ...
  describe("when the items contains generators", function () {
    ...
    describe("and the generators uses the iteration context", function () {
      beforeEach(function () {
        var increasingNumber = new Producer(function (last) {
          return last + 1;
        }, 0);
        var color = new Producer(function (_, context) {
          var index = context.colorIndex || 0;
        ...
        generator = new PicksetGenerator([increasingNumber.map(function (v) {
          return "0: " + v;
        }), color.map(function (v) {
          return "1: " + v;
        }), increasingNumber.map(function (v) {
          return "2: " + v;
        }), color.map(function (v) {
          return "3: " + v;
        })]);
      ...
      it("each generator gets a context for all iterations", function () {
        expect(generator, "to yield items", [["3: green"], ["0: 0", "2: 1", "1: yellow", "3: red"], ["0: 2", "1: green"], [], ["3: yellow", "1: red"], ["2: 3", "0: 4", "3: green"], ["3: yellow", "2: 5", "0: 6"], [], ["0: 7", "1: red", "3: green", "2: 8"], ["0: 9", "1: yellow"]]);
      });
    });
  });
});