...
(function (root, factory) {
  ...
  function ExtendedChance(seed) {
      ...
      unique: function unique(generator, count, options) {
        var uniqueGenerator = generatorFunction('unique', [generator, count], function () {
          ...
          return comparator ? chance.unique(function () {
            return generator();
          }, unwrap(count), { comparator: comparator }) : chance.unique(generator, unwrap(count));
        });
    ...
    var shrinkers = {
      ...
      unique: function unique(generator, data) {
        if (data.length === 0) {
          return that.constant(data);
        }
      ...
      shape: function shape(generator, data) {
      ...
      weighted: function weighted(generator, data) {
    ...
    function numberExpander(generator, data) {
      ...
      return that.weighted([that.constant(data), that.constant(data).map(function (value) {
