...
expect.addAssertion(
  "<any> [not] to be contained by <array>",
  (expect, item, array) => {
...
expect.addAssertion(
  "<string> to have length satisfying <assertion>",
  (expect, value) => {
...
describe("chance-generators", () => {
  ...
  describe("string", () => {
    ...
    describe("map", () => {
      it("returns a new generator where the generated values are mapped with the given function", () => {
        ...
        expect(generator, "when called", "to match", /[A-Z-]*/);
      });

      describe("shrink", () => {
        it("returns a new generator where the input is shrunken with with regards to the original generator", () => {
          let generator = chance
            .string({ length: chance.natural({ max: 10 }) })
            .map(s => s.toUpperCase())
            .map(s => s.replace(/[^A-Z]/g, "-"));
  ...
  describe("n", () => {
    ...
    describe("given a generator function and another generator producing numbers", () => {
      it("returns a new generator producing arrays with the length specified by the second generator", () => {
        expect(
          chance.n(chance.string, chance.integer({ min: 2, max: 4 })),
          "when called",
          "to satisfy",
          {
  ...
  describe("array", () => {
    ...
    describe("given a generator function and another generator producing numbers", () => {
      it("returns a new generator producing arrays with the length specified by the second generator", () => {
        expect(
          chance.array(chance.string, chance.integer({ min: 2, max: 4 })),
          "when called",
          "to satisfy",
          {
            length: expect.it("to be within", 2, 4)
  ...
  describe("arraySplicer", () => {
    ...
    describe("when given items that are generators", () => {
      it("unwraps the items", () => {
        ...
        const generator = chance.arraySplicer([
          valueGenerator,
          valueGenerator,
          "foo",
          42
      ...
      it("shrinks the item generators", () => {
        ...
        let generator = chance.arraySplicer(
          [valueGenerator, valueGenerator, "foo", 42],
          { min: 2 }
        );
  ...
  describe("shuffle", () => {
    ...
    describe("given an array of generators", () => {
      it(
        "returns a new generator producing shuffled versions of the given array " +
          "where items are generated by the generators in the array",
        () => {
          expect(
            chance.shuffle([chance.integer, true, chance.string]),
            "when called",
            "to have items satisfying",
            expect
              .it("to be a number")
  ...
  describe("pick", () => {
    ...
    describe("given an array of generators", () => {
      it(
        "returns a new generator picking random elements from the array " +
          "where the items are generated by the generators in the array",
        () => {
          expect(
            chance.pick([chance.integer, chance.string, true], 2),
            "when called",
            "to have items satisfying",
            expect
              .it("to be a number")
  ...
  describe("pickset", () => {
    ...
    describe("expand", () => {
      it("returns a new generator that work on the provided data plus random data from the origin generator", () => {
        ...
        const originalGenerator = chance.pickset(
          valueGenerators,
          lengthGenerator
        );
        const expandedGenerator = originalGenerator.expand([
  ...
  describe("pickone", () => {
    ...
    describe("given an array of generators", () => {
      it(
        "returns a new generator picking a random elements from the array " +
          "where the items are generated by the generators in the array",
        () => {
  ...
  describe("unique", () => {
    describe("given a generator and a number", () => {
      it("generates arrays with unique values from that generator", () => {
        ...
        expect(
          ...
          "to satisfy",
          [[13, 3.14], [3.14, 42], [666, 3.14], [666, 42]]
        );
      });
      ...
      it("returns a new generator that returns the specified number of unique items generated by the given generator", () => {
        const arr = [42, "foo", { wat: "taw" }];
        expect(
          chance.unique(chance.pick(arr), 3),
          "when called",
          "to satisfy",
          expect
            .it("to have length", 3)
    ...
    describe("shrink", () => {
      it("generates smaller sub-sets of the given data", () => {
        const generator = chance.unique(
          chance.state,
          chance.natural({ max: 10 })
        );

        const shrunkenGenerator = generator.shrink(["SC", "WV", "FL"]);
        expect(
          [shrunkenGenerator(), shrunkenGenerator(), shrunkenGenerator()],
          "to satisfy",
          [["SC"], ["SC", "WV", "FL"], ["SC", "WV"]]
        );
      });
  ...
  describe("constant", () => {
    ...
    it("does not unwrap generators", () => {
      expect(
        chance.constant(chance.integer),
        "when called",
        "to be a function"
      );
    });
  ...
  describe("identity", () => {
    ...
    it("does not unwrap generators", () => {
      expect(
        chance.identity(chance.integer),
        "when called",
        "to be a function"
      );
    });
  ...
  describe("shape", () => {
    ...
    describe("map", () => {
      it("returns a new generator where the generated values are mapped with the given function", () => {
        ...
        expect(generator, "when called", "to match", /\d+,\d+/);
      });
      ...
      it("provides the generator instance as the second parameter to the mapper function", () => {
        expect(
          chance
            ...
            .map((length, { array, string }) => array(string({ length }))),
          "when called",
          "to have items satisfying",
  ...
  describe("sequence", () => {
    ...
    describe("shrink", () => {
      it("returns a new generator that work on the provided data", () => {
        let generator = chance.sequence((context, previous) => {
          const length =
            previous === undefined ? 50 : Math.max(0, previous.length - 1);
    ...
    describe("expand (when resumable)", () => {
      it("returns a new generator continues when the sequence generator stopped", () => {
        let generator = chance.sequence(
          (context, previous) => {
            const length =
              previous === undefined ? 25 : Math.max(0, previous.length - 1);

            return chance.string({ length });
          },
          chance.natural({ max: 30 }),
          { resumable: true }
        );
